...
func main() {
	...
	mux.HandleFunc("/process", func(w http.ResponseWriter, r *http.Request) {
		handler(sessionMap, mapPool, w, r)
	})
...
// handler serves requests from the hosts, Orange Team leaders, and Blue Team leaders.
func handler(sessionMap map[string]Session, mapPool map[string]bool, w http.ResponseWriter, r *http.Request) {
